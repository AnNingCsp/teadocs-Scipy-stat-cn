...
module.exports = {
    doc: {
        name: "Scipy.stat 中文文档", //文档名称
        description: "Scipy.stat 中文文档", //文档的描述
        version: "1.0", //文档的版本
        dir: "", //文档的目录
    ...
    theme: {
        dir: "", //主题的目录，可自定义主题
        title: "Scipy.stat 中文文档", //html的title标签
...
module.exports = {
    doc: {
        name: "Scipy.stat 中文文档",
        description: "Scipy.stat 中文文档",
        version: "0.0.1",
        dir: "./docs",
        outDir: "./build",
        staticDir: "./static"
    ...
    theme: {
        ...
        title: "Scipy.stat 中文文档",
        headHtml: `
        <meta name="description" content="Scipy.stat 中文文档" />
    ...
    nav: {
        tree: "<ul><li><a>Scipy.stat 中文文档</a></li></ul>"
    }
}
```